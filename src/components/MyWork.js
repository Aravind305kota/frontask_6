    ...
    <Fragment>
        <div className="col p-4"> 
            <div className="p-4 slide-in-top">
                ...
                <div className="row">
                    <div className="col-6">
                        <h2 className="ff-jose fw-bold ls-2 text-red">projects done by Me</h2>
                    </div>
                </div>
                <hr></hr>
                <div className="row">
                    <div className="col-md-4 text-center my-2">
                        ...
                        <div id="carouselExampleControls1" className="carousel slide my-1" data-bs-ride="carousel">
                            ...
                            <h5 className="ff-jose my-1 text-red">Accident alert system</h5>
                            <div className="row d-flex justify-content-center">
                                <a href="https://github.com/Aravind305kota/Accident-alert-system" className="col-sm-12 col-md-5 portfolio-link text-decoration-none text-white m-1 px-2 py-1 bg-blue rounded" target="_blank"><AiFillGithub/> Source Code</a>
                            </div>
                    ...
                    <div className="col-md-4 text-center my-2">
                        ...
                        <div>
                            <h5 className="ff-jose my-1 text-red">Breast cancer prediction ML model</h5>
                            <div className="row d-flex justify-content-center">
                            <a href="https://github.com/Aravind305kota/breast-cancer-prediction" className="col-sm-12 col-md-5 portfolio-link text-decoration-none text-white m-1 px-2 py-1 bg-blue rounded" target="_blank"><AiFillGithub/> Source Code</a>
                            </div>
                        </div>
